(function ($, window, document, undefined) {
    var pluginName = 'applink',
        ...
        IS_IOS = !!(/iPad|iPhone|iPod/.test(navigator.platform) || (navigator.platform === "MacIntel" && typeof navigator.standalone !== "undefined"))
        IS_ANDROID = agent.match(/android/i) !== null,
        IS_MOBILE = true || IS_ANDROID;
